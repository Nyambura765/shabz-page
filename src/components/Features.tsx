...
export const Features = () => {
  return (
    <div className="py-24 sm:py-32 bg-shabz-dark relative overflow-hidden">
          ...
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-4">
            {features.map((feature) => (
              <div key={feature.name} className="flex flex-col items-center text-center group">
                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-shabz-purple/10 group-hover:bg-shabz-purple/20 transition-colors duration-300">
